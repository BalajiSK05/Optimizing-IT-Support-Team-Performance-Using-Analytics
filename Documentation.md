...
Data cleaning is the first and most important step before analysis. In Power BI, data cleaning was performed using Power Query Editor.

🔧 Key Data Cleaning Operations Covered:
...
📅 Splitting columns (Date into Year, Month, Day)
...
EDA was performed on a Netflix dataset, and analytical questions were framed to understand:
...
🔄 Transforming API data using Power Query

⏱️ Understanding data refresh
...
🧮 Calculating KPIs using measures

🧾 Displaying KPIs using cards and visuals

🚦 Understanding KPI targets and status
...
➡️ Filter direction (Single / Both)

⭐ Importance of proper relationships for accurate calculations
...
🧱 Composite Measures (created using measures)

🧠 Understanding that measures return scalar values

🧩 CALCULATE function for applying filters

🔀 Using multiple filters in CALCULATE

🧪 Difference between CALCULATE and slicers
...
The repository is structured to maintain clarity and organization:
